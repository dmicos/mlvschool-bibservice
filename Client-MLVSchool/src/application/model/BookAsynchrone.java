...
public class BookAsynchrone {
	...
	public BookAsynchrone(Book book, String title, List<String> authors, String date, int rate, String image) {
		this.book = book;
	...
	public static BookAsynchrone createBookAsynchrone(Book book) throws RemoteException {
		...
		return new BookAsynchrone(book, title, authors, date, rate, mainImage);
	}
