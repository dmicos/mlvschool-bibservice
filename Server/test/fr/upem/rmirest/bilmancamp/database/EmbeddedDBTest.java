...
public class EmbeddedDBTest {
	...
	public void testAddBook() throws RemoteException {
		...
		Book book = new BookImpl("Les aventures de champimou", Arrays.asList("Quentin"),
				"Un r�cit d'aventure exceptionnel", Arrays.asList("Romance"), 666.42,
	...
	public void testSearchBookFromKeywords() throws RemoteException {
		...
		Book book1 = new BookImpl("Les aventures de Champimou", Arrays.asList("Quentin"),
				"Un r�cit d'aventure exceptionnel", Arrays.asList("Romance"), 666.42, Arrays.asList("saga"), image(),
				Arrays.asList(image()));
		Book book2 = new BookImpl("Les nouvelles aventures de Champidur", Arrays.asList("JYT"),
				"Un voyage vers des contr�es nouvelles", Arrays.asList("SF"), 666.42, Arrays.asList("saga"), image(),
				Arrays.asList(image()));
	...
	public void testGetBookMostSimilar() throws RemoteException {
		...
		Book book1 = new BookImpl("Les aventures de Champimou", Arrays.asList("Quentin"),
				"Un r�cit d'aventure exceptionnel", Arrays.asList("SF"), 666.42, Arrays.asList("saga"), image(),
				Arrays.asList(image()));
		// "de", "sf", "saga" : 3
		Book book2 = new BookImpl("Le retour de ChampiMou", Arrays.asList("Yannerson"),
				"Le spectre du mal r�de � nouveau", Arrays.asList("SF"), 666.42, Arrays.asList("saga"), image(),
				Arrays.asList(image()));
		// No matches
