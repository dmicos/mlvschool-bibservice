...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements fr.upem.rmirest.bilmancamp.bank.BankServiceService {
    ...
    public fr.upem.rmirest.bilmancamp.bank.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.upem.rmirest.bilmancamp.bank.BankServiceSoapBindingStub _stub = new fr.upem.rmirest.bilmancamp.bank.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.upem.rmirest.bilmancamp.bank.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.upem.rmirest.bilmancamp.bank.BankServiceSoapBindingStub _stub = new fr.upem.rmirest.bilmancamp.bank.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
