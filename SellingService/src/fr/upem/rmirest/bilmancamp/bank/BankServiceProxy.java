...
public class BankServiceProxy implements fr.upem.rmirest.bilmancamp.bank.BankService {
  private String _endpoint = null;
  private fr.upem.rmirest.bilmancamp.bank.BankService bankService = null;
  ...
  private void _initBankServiceProxy() {
    try {
      bankService = (new fr.upem.rmirest.bilmancamp.bank.BankServiceServiceLocator()).getBankService();
      if (bankService != null) {
        if (_endpoint != null)
  ...
  public fr.upem.rmirest.bilmancamp.bank.BankService getBankService() {
    if (bankService == null)
      _initBankServiceProxy();
    return bankService;
  }
